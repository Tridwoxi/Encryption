...
public class RoundFunction {
    ...
    public static void main(String[] args) {
        ...
        String result = round_function(input, key);
        System.out.println(result);
    }

    /**
        The Rijndael round function {@code f}. Accepts part of the codeblock and a key. XORs using {@link exclusive_or}, substitues each byte using {@link substitute}, and permutes using {@link permute} as part of the encryption process.
    
        @param input    part of the codeblock, binary string of length 32
        @param key      the key used for salting, binary string of length 32
        @return         a funny amalgamation of the input and key
     */
    public static String round_function(String input, String key) {
        String result;
        result = exclusive_or(input, key);
